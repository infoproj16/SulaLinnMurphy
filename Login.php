...
?>
		...
		<!-- creating the button -->    
			...
			<a href='template1createuser.php'><span class = "btn btn-default"> Create User</span></a></li>
			
			<!--<button type="submit" class="btn btn-default" name="submit"><createuser</button>
			<!--<li><a href="template1createuser.php">Create user</a></li>-->
		</form>
